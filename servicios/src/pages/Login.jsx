...
<div className="min-h-screen flex items-center justify-center bg-gray-100">
    ...
    <h2 className="text-2xl font-bold mb-6 text-center">Tienda de Electrónicos</h2>
    {error && <Alerta type="error" message={error} />}
    <form onSubmit={handleLogin}>
    <div className="mb-4">
    <label className="block text-gray-700">Usuario</label>
    <input type="text" className="w-full border p-2 rounded mt-1" value={username} onChange={(e) => setUsername(e.target.value)} />
</div>
<div className="mb-6">
